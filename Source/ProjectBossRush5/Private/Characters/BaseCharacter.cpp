...
{
	if (m_CombatTarget && m_CombatTarget->ActorHasTag(FName("Dead")))
	{
...
{
	const int32 Selection = PlayRandomMontageSection(m_DeathMontage, m_DeathMontageSections);
...
{
	return m_Attributes && m_Attributes->IsAlive();
}
